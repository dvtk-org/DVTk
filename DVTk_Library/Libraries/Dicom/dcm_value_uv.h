...
#ifndef DCM_VALUE_UV_H
#define DCM_VALUE_UV_H
...
#include "../AttributeGroup/value_uv.h"	// UV VR value

//>>***************************************************************************
class DCM_VALUE_UV_CLASS : public VALUE_UV_CLASS

//  DESCRIPTION     : DCM UV value class.
//  INVARIANT       :
...
public:
    ...
    bool operator = (DCM_VALUE_UV_CLASS&);
};

#endif /* DCM_VALUE_UV_H */
