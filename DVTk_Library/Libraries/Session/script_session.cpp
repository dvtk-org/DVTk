...
//<<===========================================================================
{
	...
	for (UINT i = 0; i < associateRq_ptr->noPresentationContexts(); i++)
	{
		...
		{
			if (reqPC.getAbstractSyntaxName() == associateRq_ptr->getUserInformation().getScpScuRoleSelect(i).getUid())
			{
				found = true;
				break;
			}
		...
		if(reqSopUid == STORAGE_COMMITMENT_PUSH_MODEL_SOP_CLASS_UID && !found)
		{
