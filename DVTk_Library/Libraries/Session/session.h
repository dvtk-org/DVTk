...
public:
    ...
    virtual void setMaxTlsVersion(const char*) { }

    virtual void setMinTlsVersion(const char*) { }
    ...
    virtual const char* getMaxTlsVersion() { return NULL; }

    virtual const char* getMinTlsVersion() { return NULL; }
