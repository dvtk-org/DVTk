...
//<<***************************************************************************
{
	public:
        ...
        virtual DCM_ATTRIBUTE_CLASS *Navigate(DCM_ATTRIBUTE_GROUP_CLASS*, DCM_ATTRIBUTE_GROUP_CLASS*, LOG_CLASS*, bool parent_only = false) = 0;
...
//<<***************************************************************************
{
	public:
		...
		CONDITION_NAVIGATION_HERE_NODE_CLASS(bool po);
		~CONDITION_NAVIGATION_HERE_NODE_CLASS();

		bool GetParentOnly() { return parent_only; }
        DCM_ATTRIBUTE_CLASS *Navigate(DCM_ATTRIBUTE_GROUP_CLASS*, DCM_ATTRIBUTE_GROUP_CLASS*, LOG_CLASS*, bool parent_only);
...
class CONDITION_NAVIGATION_ROOT_NODE_CLASS : public CONDITION_NAVIGATION_NODE_CLASS

	//  DESCRIPTION     : Navigation Root Node Class
	//  INVARIANT       :
	//  NOTES           :
	//<<***************************************************************************
{
