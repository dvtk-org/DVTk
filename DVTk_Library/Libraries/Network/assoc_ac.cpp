...
//<<===========================================================================
{
	...
	{
		PRESENTATION_CONTEXT_AC_CLASS sourcePc = sourceAssociateAc_ptr->getPresentationContext(i);
...
void ASSOCIATE_AC_CLASS::setZeroPresentationContextIds_backup(ASSOCIATE_AC_CLASS *sourceAssociateAc_ptr)
