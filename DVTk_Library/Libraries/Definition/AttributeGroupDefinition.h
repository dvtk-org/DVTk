...
public:
	...
	void SetValueConditionText(const string condition_text) { value_condition_text = condition_text; }

	string GetValueConditionText() { return value_condition_text; }
