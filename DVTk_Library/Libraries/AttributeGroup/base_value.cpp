...
//<<===========================================================================
{
    ...
    case ATTR_VR_SV:    return (new (VALUE_SV_CLASS));
    ...
    case ATTR_VR_UV:    return (new (VALUE_UV_CLASS));
...
//<<===========================================================================
{
    ...
    case ATTR_VR_SV:    return SV_LENGTH;
    ...
    case ATTR_VR_UV:    return UV_LENGTH;
...
DVT_STATUS BASE_VALUE_CLASS::Set(UINT64)
...
DVT_STATUS BASE_VALUE_CLASS::Set(INT64)
...
DVT_STATUS BASE_VALUE_CLASS::Get(UINT64 &)

//  DESCRIPTION     : Get value to UINT64.
//  PRECONDITIONS   :
//  POSTCONDITIONS  :
//  EXCEPTIONS      :
//  NOTES           :
...
DVT_STATUS BASE_VALUE_CLASS::Get(INT64 &)

//  DESCRIPTION     : Get value to INT64.
//  PRECONDITIONS   :
//  POSTCONDITIONS  :
//  EXCEPTIONS      :
//  NOTES           :
