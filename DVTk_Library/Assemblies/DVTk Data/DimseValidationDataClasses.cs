...
namespace DvtkData.Validation
{
    ...
    namespace SubItems
    {
        ...
        public class ValidationAttributeGroupResult : IDvtDetailToXml, IDvtSummaryToXml, IDvtTestLogToXml
        {
            ...
            /// </summary>
            public string ValueConditionText
            {
                get
                {
                    return _ValueConditionText;
                }
                set
                {
                    _ValueConditionText = value;
                }
            }
            private string _ValueConditionText = System.String.Empty;
            ...
            public virtual bool DvtDetailToXml(StreamWriter streamWriter, int level)
            {
                ...
                if (level == 0)
                {
                    if (usage == "C")
                    {
                        streamWriter.WriteLine("<Module Name=\"{0}\" Usage=\"{1}: {2}\">", Name, usage, ValueConditionText);
                    }
                    else
                    {
