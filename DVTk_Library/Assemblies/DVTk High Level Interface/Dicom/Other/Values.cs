...
namespace DvtkHighLevelInterface.Dicom.Other
{
	...
	public class Values
	{
		...
		internal DvtkData.Collections.NullSafeCollectionBase CollectionImplementation
		{
			get
			{
				...
				switch(this.attribute.VR)
				{
                    ...
                    case VR.SV: // Signed Very Long String
                        DvtkData.Dimse.SignedVeryLongString theSignedVeryLongString = dicomValue as DvtkData.Dimse.SignedVeryLongString;
                        collection = theSignedVeryLongString.Values;
                        break;
                    ...
                    case VR.UV: // Unsigned Long
                        DvtkData.Dimse.UnsignedVeryLongString theUnsignedVeryLongString = dicomValue as DvtkData.Dimse.UnsignedVeryLongString;
                        collection = theUnsignedVeryLongString.Values;
                        break;
		...
		internal bool IsImplementedWithCollection
		{
			get
			{
				...
				switch(this.attribute.VR)
				{
					...
					case VR.UL: // Unsigned Long
                    case VR.US: // Unsigned Short
                    case VR.UV: // Unsigned Very Long String
                    case VR.UC: // Unlimited Characters
        ...
        /// <summary>
        /// Converts the supplied array to a DvtkData Int64Collection.
        /// </summary>
        /// <remarks>
        /// When an array element is null, it will be skipped.<br></br><br></br>
        /// When an array element cannot be converted, it will be interpreted as a 0.
        /// </remarks>
        /// <param name="objects">The array to convert.</param>
        /// <returns>The returned DvtkData Int64Collection.</returns>
        private DvtkData.Collections.Int64Collection ConvertToInt64Collection(object[] objects)
        {
            DvtkData.Collections.Int64Collection int64Collection = new DvtkData.Collections.Int64Collection();
            ...
            foreach (object item in objects)
            {
                if (item != null)
                {
                    ...
                    try
                    {
                        int64Value = System.Convert.ToInt64(item);
                    }
                    catch
                    {
                        int64Value = 0;
                    ...
                    int64Collection.Add(int64Value);
                }
            }
        ...
        /// <summary>
        /// Converts the supplied array to a DvtkData UInt64Collection.
        /// </summary>
        /// <remarks>
        /// When an array element is null, it will be skipped.<br></br><br></br>
        /// When an array element cannot be converted, it will be interpreted as a 0.
        /// </remarks>
        /// <param name="objects">The array to convert.</param>
        /// <returns>The returned DvtkData UInt64Collection.</returns>
        private DvtkData.Collections.UInt64Collection ConvertToUInt64Collection(object[] objects)
        {
            DvtkData.Collections.UInt64Collection uInt64Collection = new DvtkData.Collections.UInt64Collection();
            ...
            foreach (object item in objects)
            {
                if (item != null)
                {
                    ...
                    try
                    {
                        uInt64Value = System.Convert.ToUInt64(item);
                    }
                    catch
                    {
                        uInt64Value = 0;
                    ...
                    uInt64Collection.Add(uInt64Value);
                }
            }
        ...
        private String GetCollectionValue(int zeroBasedIndex)
        {
            ...
            switch (this.attribute.VR)
            {
                ...
                case VR.SV: // Signed Very Long String
                    singleValue = (CollectionImplementation as DvtkData.Collections.Int64Collection)[zeroBasedIndex].ToString();
                    break;
                ...
                case VR.UV: // Unsigned Very Long String
                    singleValue = (CollectionImplementation as DvtkData.Collections.UInt64Collection)[zeroBasedIndex].ToString();
                    break;
        ...
        internal void InsertCollectionValues(int zeroBasedIndex, params Object[] parameters)
        {
            switch (this.attribute.VR)
            {
                ...
                case VR.SV: // Signed Very Long String
                    {
                        DvtkData.Collections.Int64Collection collectionToAdd = ConvertToInt64Collection(parameters);
                        DvtkData.Collections.Int64Collection currentCollection = (CollectionImplementation as DvtkData.Collections.Int64Collection);
                        for (int index = 0; index < collectionToAdd.Count; index++)
                        {
                            currentCollection.Insert(zeroBasedIndex + index, collectionToAdd[index]);
                        }
                ...
                case VR.UV: // Unsigned Very Long String
                    {
                        DvtkData.Collections.UInt64Collection collectionToAdd = ConvertToUInt64Collection(parameters);
                        DvtkData.Collections.UInt64Collection currentCollection = (CollectionImplementation as DvtkData.Collections.UInt64Collection);
                        for (int index = 0; index < collectionToAdd.Count; index++)
                        {
                            currentCollection.Insert(zeroBasedIndex + index, collectionToAdd[index]);
                        }
