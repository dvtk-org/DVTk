        ...
        , IConfigurableSut
    {
        ...
        public virtual void CopySettingsFrom(ScriptSession scriptSession)
        {
            ...
            if (scriptSession.SecuritySettings.SecureSocketsEnabled)
            {
                ...
                SecuritySettings.MaxTlsVersionFlags = scriptSession.SecuritySettings.MaxTlsVersionFlags;
                SecuritySettings.MinTlsVersionFlags = scriptSession.SecuritySettings.MinTlsVersionFlags;
            }
