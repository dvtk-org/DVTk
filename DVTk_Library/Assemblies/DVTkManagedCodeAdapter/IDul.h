...
namespace Wrappers
{
    public interface class IDul
    {
       /* __property System::String __gc* get_DvtAeTitle();
        ...
        property System::String^ SutAeTitle
        {
            System::String^ get();
            void set(System::String^ value);
        }
        ...
        property System::UInt32 DvtMaximumLengthReceived
        {
            System::UInt32 get();
        ...
        property System::UInt32 SutMaximumLengthReceived
        {
            System::UInt32 get();
            void set(System::UInt32 value);
        }
        ...
        property System::String^ DvtImplementationClassUid
        {
            System::String^ get();
            void set(System::String^ value);
        }
        ...
        property System::String^ SutImplementationClassUid
        {
            System::String^ get();
            void set(System::String^ value);
        }
        ...
        /*
        System::String __gc* get_DvtImplementationVersionName();
        __property void set_DvtImplementationVersionName(System::String __gc* value);*/

        property System::String^ DvtImplementationVersionName
        {
            System::String^ get();
            void set(System::String^ value);
        }
        ...
        void set_SutImplementationVersionName(System::String __gc* value);*/

        property System::String^ SutImplementationVersionName
        {
            System::String^ get();
            void set(System::String^ value);
        }
