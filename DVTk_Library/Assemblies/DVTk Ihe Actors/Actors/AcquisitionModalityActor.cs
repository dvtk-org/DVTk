...
namespace Dvtk.IheActors.Actors
{
	...
	public class AcquisitionModalityActor : BaseActor, IAcquisitionModalityActor
	{
        ...
        /// <returns></returns>
        public bool SendNSetModalityProcedureStepCompleted(System.String mppsCompletedDcmFilename, string retrieveAETitle, string seriesDescription)
        {
            // Initialize the mpps completed
            InitializeModalityProcedureStepCompletedDiscontinued();
            ...
            DvtkHighLevelInterface.Dicom.Messages.DicomMessage nSetMppsCompleted = new DvtkHighLevelInterface.Dicom.Messages.DicomMessage(DvtkData.Dimse.DimseCommand.NSETRQ);
            GenerateTriggers.MakeNSetMppsCompletedDiscontinued(mppsCompletedDcmFilename, DefaultValueManager, _storageCommitItems, nSetMppsCompleted, _mppsInstanceUid, retrieveAETitle, seriesDescription);
        ...
        public bool SendModalityImagesStored(System.String storageDirectory, DicomQueryItem modalityWorklistItem, bool withSingleAssociation, string retrieveAETitle)
        {
            ...
            foreach (FileInfo fileInfo in directoryInfo.GetFiles())
            {
                    ...
                    (fileInfo.Extension == System.String.Empty))
                {
                    ...
                    //dataset.AddAttribute(Tag.RETRIEVE_AE_TITLE.GroupNumber, Tag.RETRIEVE_AE_TITLE.ElementNumber, VR.AE, retrieveAETitle);
        ...
        public bool SendModalityImagesStored(DicomQueryItem modalityWorklistItem, bool withSingleAssociation, string retrieveAETitle)
        {
            ...
            return SendModalityImagesStored(storageDirectory, modalityWorklistItem, withSingleAssociation, retrieveAETitle);
        }
