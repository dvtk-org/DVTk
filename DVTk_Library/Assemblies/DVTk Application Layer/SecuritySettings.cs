...
namespace DvtkApplicationLayer
{
    ...
    public class SecuritySettings
    {
        ...
        private TlsVersionFlags maxTlsVersionFlags;
        private TlsVersionFlags minTlsVersionFlags;
        ...
        /// </summary>
        public TlsVersionFlags MaxTlsVersionFlag
        {
            get
            {
                return maxTlsVersionFlags;
            }
            set
            {
                maxTlsVersionFlags = value;
            }
        }

        public TlsVersionFlags MinTlsVersionFlag
        {
            get
            {
                return minTlsVersionFlags;
            }
            set
            {
                minTlsVersionFlags = value;
            }
        }
        ...
        public TlsVersionFlags Convert(DvtkSession.TlsVersionFlags value)
        {
            switch (value)
            {
                case DvtkSession.TlsVersionFlags.TLS_VERSION_TLSv1_0:
                    return TlsVersionFlags.TLS_VERSION_TLSv1_0;
                case DvtkSession.TlsVersionFlags.TLS_VERSION_TLSv1_1:
                    return TlsVersionFlags.TLS_VERSION_TLSv1_1;
                case DvtkSession.TlsVersionFlags.TLS_VERSION_TLSv1_2:
                    return TlsVersionFlags.TLS_VERSION_TLSv1_2;
                case DvtkSession.TlsVersionFlags.TLS_VERSION_TLSv1_3:
                    return TlsVersionFlags.TLS_VERSION_TLSv1_3;
                default:
                    throw new System.NotSupportedException();
            }
        }
